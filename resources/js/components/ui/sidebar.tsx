    ...
    return (
        <main
            ...
            className={cn(
                ...
                'peer-data-[side=right]:md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2 peer-data-[side=right]:md:peer-data-[variant=inset]:peer-data-[state=collapsed]:mr-2',
                className,
            )}
            {...props}
        />
    ...
    ({ className, asChild = false, ...props }, ref) => {
        ...
        return (
            <Comp
                ...
                className={cn(
                    'absolute right-3 rtl:right-auto rtl:left-3 top-3.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-hidden ring-sidebar-ring transition-transform hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
...
>(({ className, asChild = false, showOnHover = false, ...props }, ref) => {
    ...
    return (
        <Comp
            ...
            className={cn(
                'absolute right-1 rtl:right-auto rtl:left-1 top-1.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-hidden ring-sidebar-ring transition-transform hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 peer-hover/menu-button:text-sidebar-accent-foreground [&>svg]:size-4 [&>svg]:shrink-0',
                // Increases the hit area of the button on mobile.
                'after:absolute after:-inset-2 md:after:hidden',
...
const SidebarMenuBadge = React.forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(({ className, ...props }, ref) => (
    <div
        ...
        className={cn(
            'pointer-events-none absolute right-1 rtl:right-auto rtl:left-1 flex h-5 min-w-5 select-none items-center justify-center rounded-md px-1 text-xs font-medium tabular-nums text-sidebar-foreground',
